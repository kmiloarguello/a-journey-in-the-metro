...
/*! \fn graphe * Symetrique(graphe * g)
    ...
    \return un graphe.
    \brief construit et retourne le graphe g_1 sym�trique du graphe g (algorithme lin�aire)
...
/*! \fn graphe * Kruskal1(graphe * g, graphe *g_1)
    \param g (entr�e) : un graphe pond�r� connexe sans boucle.
    \param g_1 (entr�e) : le graphe sym�trique de g.
    \return un arbre. 
...
/*! \fn graphe * Kruskal2(graphe * g, graphe *g_1)
    ...
    \return un arbre. 
    \brief retourne un arbre de poids maximal pour g.
    \warning les donn�es du graphe d'origine seront d�truites. 
*/
